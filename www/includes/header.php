...
/**
 * includes/header.php
 * Shared document shell + premium navigation v3.0
 */
...
$meta_description ??= BMV_NAME . ': Frisches Mittagessen täglich geliefert in Potsdam und Werder (Havel). Essen auf Rädern für Senioren, Familien und Unternehmen.';
$active_nav       ??= 'home';
$canonical        ??= BMV_URL . '/';
$schema_extra     ??= '';
...
<head>
  ...
  <script type="application/ld+json">
  {
    ...
    "geo": { "@type": "GeoCoordinates", "latitude": 52.3869, "longitude": 12.9344 },
    "openingHours": "Mo-Fr <?= BMV_HOURS_SCHEMA_OPEN ?>-<?= BMV_HOURS_SCHEMA_CLOSE ?>",
    "openingHoursSpecification": [{"@type": "OpeningHoursSpecification","dayOfWeek": ["Monday","Tuesday","Wednesday","Thursday","Friday"],"opens": "<?= BMV_HOURS_SCHEMA_OPEN ?>","closes": "<?= BMV_HOURS_SCHEMA_CLOSE ?>"}],
    "servesCuisine": "German",
    "priceRange": "€€",
    "logo": "<?= BMV_URL ?>/assets/images/BMV_Logo_n.png",
    "image": "<?= BMV_URL ?>/assets/images/og-image.jpg",
    "areaServed": [{"@type":"City","name":"Potsdam"},{"@type":"City","name":"Werder (Havel)"},{"@type":"AdministrativeArea","name":"Potsdam-Mittelmark"}]
  }
  </script>
...
<header class="site-header" id="site-header" role="banner">
  <div class="container site-header__inner">
    <a href="/" class="site-logo" aria-label="<?= BMV_NAME ?> – Startseite">
      <img src="/assets/images/BMV_Logo_n.png" alt="BMV Menüdienst Logo" width="110" height="33" loading="eager" decoding="async">
