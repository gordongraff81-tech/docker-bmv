...
$page_title       = 'Catering Werder (Havel) | BMV Menüdienst';
$meta_description = 'Firmen-Catering direkt vor Ort in Werder (Havel): Meetings, Betriebsfeiern und Arbeitslunch vom lokalen Küchenbetrieb. Anfragen willkommen.';
$active_nav       = 'catering';
...
<main id="main-content" role="main">
  ...
  <section class="page-hero page-hero--sm" aria-labelledby="hero-heading">
    <div class="page-hero__bg">
      <?= bmv_img('/assets/images/catering-setup.jpg', 'Catering Werder (Havel) durch BMV Menüdienst', 1600, 900, true, 'page-hero__bg-img') ?>
      <div class="page-hero__overlay" aria-hidden="true"></div>
    </div>
    <div class="container">
      <div class="page-hero__content" data-reveal>
        <span class="page-hero__label">Catering Werder (Havel)</span>
        <h1 class="page-hero__heading" id="hero-heading">Catering direkt aus der Region – für Werder (Havel).</h1>
        <p class="page-hero__lead">
          Als lokaler Küchenbetrieb beliefern wir Unternehmen in Werder (Havel) mit Firmen-Catering
          ohne Zwischenstufe. Kurze Wege, frische Ware, verlässliche Zeiten.
        </p>
  ...
  <section class="section" aria-labelledby="leistungen-heading">
    <div class="container">
      <div class="section-header" data-reveal>
        ...
        <h2 class="section-title" id="leistungen-heading">Catering für jeden Anlass in Werder (Havel).</h2>
      </div>
  ...
  <section class="section final-cta" aria-labelledby="cta-heading">
    <div class="container container--narrow">
      <div class="section-header" data-reveal>
        ...
        <h2 class="section-title" id="cta-heading">Catering für Werder (Havel) direkt anfragen.</h2>
